...
namespace E25ProjetEtendu.Migrations
{
    ...
    [Migration("20250507154354_ajoutDateProduit")]
    partial class ajoutDateProduit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("E25ProjetEtendu.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Balance = 0m,
                            ConcurrencyStamp = "04e70b73-7118-4885-8685-b8d3f9d6dcdb",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGqfhiNjWlbuHkoWzKP3MqJMqAB0lgaQChCUnPXNscRD8d4UMUS5Ibcs1VU0LT8ntQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "b7be0fac-e3e0-4c01-a6d8-159ce8900e56",
            ...
            modelBuilder.Entity("E25ProjetEtendu.Models.Produit", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ProduitId = 1,
                            DateAjout = new DateTime(2025, 3, 7, 11, 43, 52, 910, DateTimeKind.Local).AddTicks(4723),
                            EstActif = true,
                            Image = "redbull.png",
                            Nom = "Red Bull",
                            Note = 4,
                        ...
                        {
                            ProduitId = 2,
                            DateAjout = new DateTime(2025, 3, 7, 11, 43, 52, 910, DateTimeKind.Local).AddTicks(4811),
                            EstActif = true,
                            Image = "pogo.jpg",
                            Nom = "Pogo",
                            Note = 3,
                        ...
                        {
                            ProduitId = 3,
                            DateAjout = new DateTime(2025, 3, 7, 11, 43, 52, 910, DateTimeKind.Local).AddTicks(4819),
                            EstActif = true,
                            Image = "eau.jpg",
                            Nom = "Bouteille d'eau",
                            Note = 5,
                        ...
                        {
                            ProduitId = 4,
                            DateAjout = new DateTime(2025, 3, 7, 11, 43, 52, 910, DateTimeKind.Local).AddTicks(4823),
                            EstActif = true,
                            Image = "chips.jpg",
                            Nom = "Chips Lay’s",
                            Note = 4,
                        ...
                        {
                            ProduitId = 5,
                            DateAjout = new DateTime(2025, 3, 7, 11, 43, 52, 910, DateTimeKind.Local).AddTicks(4826),
                            EstActif = true,
                            Image = "nutella.jpg",
                            Nom = "Nutella",
                            Note = 5,
                        ...
                        {
                            ProduitId = 6,
                            DateAjout = new DateTime(2025, 3, 7, 11, 43, 52, 910, DateTimeKind.Local).AddTicks(4829),
                            EstActif = true,
                            Image = "activia.jpg",
                            Nom = "Yogourt Activia",
                            Note = 4,
                        ...
                        {
                            ProduitId = 7,
                            DateAjout = new DateTime(2025, 3, 7, 11, 43, 52, 910, DateTimeKind.Local).AddTicks(4833),
                            EstActif = true,
                            Image = "pizza.jpg",
                            Nom = "Pizza congelée",
                            Note = 4,
                        ...
                        {
                            ProduitId = 8,
                            DateAjout = new DateTime(2025, 3, 7, 11, 43, 52, 910, DateTimeKind.Local).AddTicks(4836),
                            EstActif = true,
                            Image = "granola.jpg",
                        ...
                        {
                            ProduitId = 9,
                            DateAjout = new DateTime(2025, 5, 7, 11, 43, 52, 910, DateTimeKind.Local).AddTicks(4839),
                            EstActif = true,
                            Image = "coca.jpg",
                            Nom = "Coca-Cola",
                            Note = 3,
                        ...
                        {
                            ProduitId = 10,
                            DateAjout = new DateTime(2025, 5, 7, 11, 43, 52, 910, DateTimeKind.Local).AddTicks(4843),
                            EstActif = true,
                            Image = "sandwich.jpg",
